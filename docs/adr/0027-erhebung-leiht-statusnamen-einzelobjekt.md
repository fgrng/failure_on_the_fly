...
- Das eingebundene Design einer finalen Erhebung darf nicht still geändert
  werden. Durchgesetzt wird das an den beiden Zuordnungsmodellen selbst: Ihre
  gemeinsame Basis weist Anlegen, Ändern und Löschen ab, sobald ihre Erhebung
  kein Entwurf mehr ist. Die gleichlautenden Prüfungen der Views bleiben daneben bestehen; sie
