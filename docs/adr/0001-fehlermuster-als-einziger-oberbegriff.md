...
# Fehlermuster als einziger Oberbegriff, verortet in der Vignette

Fachdidaktisch unterscheidet man die *Fehlvorstellung* (ein fehlerhaftes mentales Konzept) vom *systematischen Fehler* (eine regelhaft falsch angewandte Prozedur) und eventuell noch weitere Konzepte. Für die Simulation sind beide identisch: eine stabile, systematisch angewandte Regel, kongruent zu der die simulierte Schüler:in handelt. Wir führen deshalb nur den Oberbegriff **Fehlermuster** und verzichten auf getrennte Typen im Modell.
...
- „Fehlvorstellung" und „systematischer Fehler" bleiben als informelle Synonyme in der Alltagssprache zulässig.
