...
- Da keine Uhr sichtbar ist, muss auch niemandem erklärt werden, warum sie zwischendurch steht. Das Anhalten ist reine interne Buchführung.
- Eine Ausbilder:in, die Anfänger:innen mehr Zeit geben will, braucht eine zweite finale Vignettenfassung. Sie ist in der Datenspur sauber unterscheidbar, anders als ein Parameter am Training.
- Die tatsächliche Sitzungsdauer übersteigt das Zeitbudget, unter Umständen deutlich. Eine harte Obergrenze gegen ewig offene Sitzungen ist nötig, hat aber nichts mit dem Gesprächsbudget zu tun.
