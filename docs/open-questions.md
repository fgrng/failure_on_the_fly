...
Offen ist, ob die Vignettenhistorie oder die einzelne Fassung den Eigentümer trägt, was mit dem offenen Entwurf geschieht, und ob Trainings und Erhebungen der weggegangenen Person mitwandern. Gehört ins Rollenmodell.
...
## 3. Instruktionen, Einwilligung, Start- und Endseiten

Die Vision nennt sie als Bestandteil der Ablaufsteuerung einer Erhebung. Im Modell tauchen sie bisher nicht auf, weil die Fragebogen-Items über genau zwei Andockpunkte gebunden werden (siehe `docs/adr/0008`) und wir keinen allgemeinen Ablauf-Schritt eingeführt haben.

Offen: Sind Einwilligungstext, Instruktion, Start- und Endseite schlicht Textfelder an der Erhebung, oder braucht es doch ein Konzept „Ablauf-Schritt"? Ersteres ist deutlich einfacher und trägt vermutlich weit genug. Hierher gehört auch der Hinweis, **dass** das Gespräch begrenzt ist, den `docs/adr/0012` verlangt.
...
## 5. Export-Formate und Granularität
...
## 6. Wiederholversuche und Sitzungsobergrenze
...
## 7. Arbeitsheft-Inhalt und Bildablage
...
## 8. Zulässige Anbieter und Modelle
