...
**Stand 2026-09-21** ([#174](https://github.com/fgrng/failure_on_the_fly/issues/174)): Die native Reasoning-Spur wird gestrichen; die frühere zweite Hälfte dieser Frage — ob Structured Output und natives Reasoning gleichzeitig möglich sind — ist damit gegenstandslos. Das einzige verbliebene Kriterium an ein Modell ist, dass es Structured Output beherrscht. Offen bleibt allein der ADR zur Anbieter- und Modellwahl.
